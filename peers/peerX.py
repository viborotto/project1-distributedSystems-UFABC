...
def receberArquivo(nome_arquivo, diretorio_peer, peer_escolhido_port):
    ...
    path_arquivo = diretorio_peer + "/" + nome_arquivo
...
class DownloadThread(threading.Thread):
    ...
    def run(self):
        print("self.arquivo_download: " + self.arquivo_download)
    ...
    def run(self):
        ...
        while True:
            ...
            ## SEARCH OPERATION: busca no servidor em quais peers o arquivo esta disponivel
                ...
                print("arquivo_download: " + arquivo_download)
...
# default para facilitar os testes em desenvolvimento
diretorio_peer = "directoryX"
diretorio_peer_conectado = "directoryY"
